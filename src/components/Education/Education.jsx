...
const Education = () => {
  return (
    <section id="education" className="py-20 pb-24 md:px-[5vw] lg:px-[10vw] font-sans bg-skills-gradient clip-path-custom-3">
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-xl p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ml-8 transform transition-transform duration-300 hover:scale-105 ${
